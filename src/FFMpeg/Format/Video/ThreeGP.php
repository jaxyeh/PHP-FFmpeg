 ...
 */
class ThreeGP extends DefaultVideo
{
    public function __construct($audioCodec = 'amr_nb', $videoCodec = 'h263')
    {
        $this
            ->setAudioCodec($audioCodec)
            ->setVideoCodec($videoCodec);

        // Preconfigured as low bandwidth speed
        $this->setKiloBitrate(80);
        $this->setAudioKiloBitrate(12);
    }
